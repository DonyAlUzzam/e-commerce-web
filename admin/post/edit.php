...
<div id="container">
  ...
  <div id="mainContent">
    <h3> Post Manager</h3>
    <img src="images/post.png" width="51" height="40" /> <a href="new.php"><img src="images/new.png" width="136" height="27" /></a> <a href="index.php"><img src="images/view.png" width="136" height="27" /></a>
    
    <?php
include "koneksi.php";
$_SESSION['id']=$_REQUEST['id'];
$id=$_SESSION['id'];
$oke=mysqli_query($koneksi, "select * from post where id_post=$id");
while($data=mysqli_fetch_array($oke)){
echo"
<form action='edit2.php' method='post' name='newpost'>
<table width='100%' border='0' id='table1'>
  <tr>
    <th colspan='2' id='title'>Edit Post</th>
  </tr>
  <tr>
    <td width='20%' id='judul'><strong>Post title</strong></td>
    <td>:
    <input type='text' name='title' maxlength='100' size='85' value='$data[title_post]'/></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan='2'><textarea name='content' cols='85%' rows='20'> $data[content_post] </textarea></td>
  </tr>
  <tr>
